<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-title v-if="value._links">
            kitchen # {{decode(value._links.self.href.split("/")[value._links.self.href.split("/").length - 1])}}
        </v-card-title >
        <v-card-title v-else>
            kitchen
        </v-card-title >        
        ...
        <v-card-text>
            ...
            <String label="MunuState" v-model="value.munuState" :editMode="editMode" :inputUI="''"/>
